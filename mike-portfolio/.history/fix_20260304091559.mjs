      ...
      <section id="contact" style={{ padding: '96px 64px' }}>
        <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 24, padding: 64, textAlign: 'center', maxWidth: 640, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
           <motion.div initial={{ opacity: 0, x: 60 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.4 }} style={{ flex: 1, width: '100%', maxWidth: 480, display: 'flex', flexDirection: 'column', gap: 24, alignItems: 'center' }}>
          <div style={{ position: 'relative', width: 280, height: 340, border: '2px solid rgba(0,102,255,0.4)', borderRadius: 16, overflow: 'hidden', boxShadow: '0 0 40px rgba(0,102,255,0.2)' }}>
