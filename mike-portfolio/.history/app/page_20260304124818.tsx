...
const RESPONSES = {"rag":"RAG pipeline:\n-> Semantic chunking\n-> Vector DB storage\n-> Hybrid retrieval\n-> MMR reranking\n-> Prompt orchestration","aws":"AWS work:\n-> Multi-AZ with ALB\n-> Auto Scaling Groups\n-> 99.9% uptime SLA\n-> CodePipeline CI/CD","agent":"Agentic system:\n-> Planner decomposes tasks\n-> Executors call tools\n-> Critic validates\n-> Orchestrator manages state","hire":"Yes actively looking!\n-> RAG production systems\n-> AWS at scale\n-> 26+ countries deployed\nEmail: mikencube03@gmail.com","default":"Mikes AI assistant!\nSpecializing in:\n-> RAG architectures\n-> Agentic AI\n-> AWS infrastructure"};
